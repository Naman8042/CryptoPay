...
const Navbar = () => {
  ...
  <nav className="max-w-7xl w-full mx-auto px-4 flex flex-wrap basis-full items-center justify-between">
    <a className="sm:order-1 flex-none text-3xl font-semibold focus:outline-hidden focus:opacity-80" href="#">BlockPay</a>
    ...
    <div id="hs-navbar-alignment" className="hs-collapse hidden overflow-hidden transition-all duration-300 basis-full grow sm:grow-0 sm:basis-auto sm:block sm:order-2" aria-labelledby="hs-navbar-alignment-collapse">
      <div className="flex flex-col gap-8 mt-5 sm:flex-row sm:items-center sm:mt-0 sm:ps-5">
        <Link className="font-xl text-base text-gray-600 hover:text-gray-400 focus:outline-hidden" href="/" aria-current="page">Home</Link>
        <Link className="font-xl text-base text-gray-600 hover:text-gray-400 focus:outline-hidden focus:text-gray-400" href="/docs">SDK</Link>
        <Link className="font-xl text-base text-gray-600 hover:text-gray-400 focus:outline-hidden focus:text-gray-400" href="#">API</Link>
        {/* <a className="font-medium text-gray-600 hover:text-gray-400 focus:outline-hidden focus:text-gray-400" href="#">Blog</a> */}
      </div>
    </div>
  </nav>
</header>
